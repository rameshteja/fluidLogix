...
import FileUploadDropzone, { UploadedDocInfo } from "@/components/common/FileUploadDropzone";
        ...
        <div className="w-screen max-w-2xl bg-card border-l border-border/80 shadow-2xl flex flex-col h-full overflow-hidden drawer-panel-animate drawer-glow-edge">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  Register vehicle specs, compartments, KYC certificates & fleet photos
                </p>
              </div>
            </div>
          ...
          <form onSubmit={handleSubmit} className="flex-1 flex flex-col min-h-0 overflow-hidden">
            <div className="flex-1 overflow-y-auto p-6 space-y-6 custom-scrollbar text-xs">
              {/* Section 1: Tanker Registration & Specs */}
              ...
              {/* Section 2: Ownership & Crew with Searchable Autocomplete Dropdowns */}
              <div className="rounded-2xl border border-border bg-muted/10 p-4 space-y-4">
                <div className="text-xs font-bold text-foreground flex items-center gap-2 pb-2 border-b border-border/60">
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                  {/* Fleet Owner / Transporter Autocomplete */}
                  <div>
                    <AutocompleteFilter
              ...
              {/* Section 4: Vehicle Compliance & Certificates Uploads */}
              <div className="rounded-2xl border border-border bg-muted/10 p-4 space-y-4">
                <div className="text-xs font-bold text-foreground flex items-center gap-2 pb-2 border-b border-border/60">
              ...
              {/* Section 5: Multiple Tanker Photos with Drag & Drop Zone and Preview */}
              <div className="rounded-2xl border border-border bg-muted/10 p-4 space-y-4">
                <div className="text-xs font-bold text-foreground flex items-center gap-2 pb-2 border-b border-border/60">
              ...
              >
                {isSubmitting ? (
                  <>
                    ...
                    <span>Registering Tanker...</span>
                  </>
                ) : (
                  <span>Register Tanker</span>
                )}
              </button>
            </div>
          </form>
