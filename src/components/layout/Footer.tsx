    ...
    <footer className="border-t border-[#172A3A] bg-[#071522]">
      <div className="mx-auto flex max-w-7xl flex-col gap-5 px-5 py-7 md:flex-row md:items-center md:justify-between lg:px-8">
        ...
        <div className="flex flex-wrap gap-5 text-xs text-[#607B98]">
          <Link href="/#features" className="hover:text-[#FFA500] transition">
            Features
          </Link>
          <Link href="/about" className="hover:text-[#FFA500] transition">
            About Us
          </Link>
          <Link href="/register/owner" className="hover:text-[#FFA500] transition">
            Owner Registration
          </Link>
          <Link href="/register/company" className="hover:text-[#FFA500] transition">
            Company Registration
          </Link>
          <Link href="/contact" className="hover:text-[#FFA500] transition">
            Contact & Support
          </Link>
          <Link href="/login" className="hover:text-[#FFA500] transition">
            Portal Login
          </Link>
        </div>
      </div>
